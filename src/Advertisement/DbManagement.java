...
public class DbManagement {
    static Map <Integer, Users> users = new HashMap();
    Map <Integer, ForRent> rentAds = new HashMap <>();
    Map <Integer, ForSell> sellAds = new HashMap <>();
    Map <Integer, SearchRoommate> mateAds = new HashMap <>();
